...
public class assignment2 {
	...
	public static void main(String[] args) {
		...
		if(x>0 && y>0) {
			System.out.println("제 1사분면: "+ x +">0, "+y+">0");			
		}else if(x<0 && y>0) {
			System.out.println("제 2사분면: "+ x +"<0, "+y+">0");	
		}else if(x<0 && y<0) {
			System.out.println("제 3사분면: "+ x +"<0, "+y+"<0");
		}else {
			System.out.println("제 4사분면: "+ x +">0, "+y+"<0");
		}
		...
		if(year%4==0 ? year%100==0 : year%400==0) {
			...
			System.out.println(year+"년은 윤년입닙니다");
		}
